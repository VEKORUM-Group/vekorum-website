(() => {
  ...
  const primaryNav = `<a href="${rootUrl}index.html#about">Who We Are</a><a href="${rootUrl}index.html#services">Services</a><a href="${rootUrl}region/index.html">Region</a><a href="${rootUrl}work/index.html">Work</a><a href="${rootUrl}industries/index.html">Industries</a><a href="${rootUrl}insights/index.html">Insights</a><a href="${rootUrl}index.html#method">Method</a><a class="nav-cta" href="${rootUrl}index.html#contact">Start a conversation <span>&#8599;</span></a>`;
